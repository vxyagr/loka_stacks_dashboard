...
const StatsCard = () => {
  return (
    <div className=" flex rounded-md  p-4 text-sm text-left justify-center items-center">
      ...
      <div className="flex-col w-2/5 justify-center items-start h-full border-[1px] border-gray-500 rounded-xl p-5 ">
        <EnergyCard />
      </div>
    </div>
  );
