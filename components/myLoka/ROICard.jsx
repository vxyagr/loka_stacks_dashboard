const ROICard = () => {
  return (
    <div className="flex-col w-full p-0   ">
      ...
      <div className="w-full p-0 grid border-t-[1px] border-gray-500 h-3/6 ">
        <div className="grid w-full justify-center items-center ">
          <div className="w-full justify-start text-sm text-white text-center p-0">
            ROI
          </div>
          <div className="w-full justify-start text-2xl text-yellow-400 text-center p-2">
            40%
          </div>
          <div className="w-full justify-start text-right p-0 ">
      ...
      <div className="w-full p-2 grid  border-t-[1px] border-gray-500 h-1/6">
        <div className="grid w-full justify-center items-center ">
          <div className="w-full justify-start text-sm text-white text-center p-0">
            75 days left
          </div>
